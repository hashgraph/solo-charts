...
# kind load docker-image ghcr.io/hashgraph/solo-containers/kubectl-bats:0.43.0 --name solo-charts-test
# kind load docker-image ghcr.io/hashgraph/solo-containers/ubi8-s6-java25:0.43.0 --name solo-charts-test
